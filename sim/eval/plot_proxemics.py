...
# Proxemic boundary line
SHOW_PROXEMIC_BOUNDARY = True
PROXEMIC_BOUNDARY_DISTANCE = 1.2  # meters
PROXEMIC_BOUNDARY_COLOR = "red"
PROXEMIC_BOUNDARY_STYLE = ":"
PROXEMIC_BOUNDARY_WIDTH = 2.0
PROXEMIC_BOUNDARY_ALPHA = 0.7
PROXEMIC_BOUNDARY_LABEL = "Proxemic Boundary (1.2m)"
...
def main():
    ...
    # Plot proxemic boundary line
    if SHOW_PROXEMIC_BOUNDARY:
        ax.axhline(y=PROXEMIC_BOUNDARY_DISTANCE,
                   color=PROXEMIC_BOUNDARY_COLOR,
                   linestyle=PROXEMIC_BOUNDARY_STYLE,
                   linewidth=PROXEMIC_BOUNDARY_WIDTH,
                   alpha=PROXEMIC_BOUNDARY_ALPHA,
                   label=PROXEMIC_BOUNDARY_LABEL)
